import 'package:digitalwebber/view/drawer_section/career/widgets/career_widget.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: customText("Career", color: kWhite),
      ),
      body: SafeArea(
            ...
            child: Column(
              children: [
                /*  Container(
                  ...
                  padding: EdgeInsets.fromLTRB(12.h, 12.h, 12.h, 32.h),
                  child: customLogo(
                    'assets/logo.png',
                    size: 58,
                    onTap: () {},
