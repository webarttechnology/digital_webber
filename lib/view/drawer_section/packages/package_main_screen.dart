...
class PackageScreen extends StatefulWidget {
  const PackageScreen({super.key, this.isBack});
...
class _PackageScreenState extends State<PackageScreen> {
                        ...
                        switch (index) {
                          ...
                          /*  case 1:
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => DesignTemplateScreen(
                                          index: index,
                                          headerData: packageList,
                                          listItem: seoList,
                                          iconList: iconData,
                                        )));
                            break;
  ...
  static const packageList = [
    ...
    [
      "Highlevel Marketing\nSAAS Model",
      "assets/sitedata/highlevel.png",
      "Highlevel Marketing SAAS Model",
      "Highlevel Marketing SAAS Model",
      "The powerful visuals that move your business forward.",
    ],
  ];
