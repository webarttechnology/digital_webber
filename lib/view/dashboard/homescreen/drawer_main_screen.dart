...
import 'package:digitalwebber/view/dashboard/carrer/carrer_screen.dart';
...
import 'package:digitalwebber/view/dashboard/homescreen/widgets/drawer_list_tile_widget.dart';
                  ...
                  /*    switch (index) {
                    ...
                    case 4:
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const CarrerScreen()));
                      break;
                    case 5:
                      Navigator.push(
                          context,
